...
public:
    ...
    void clear();
    // Nach einer erfolgreichen Aktualisierung die angewendeten Pakete entfernen.
    // Ohne Teilaktualisierung (Arch) wurde alles angewendet, sonst nur die Auswahl.
    void removeApplied(bool allPackages);
