        ...
        Column {
            ...
            Row {
                ...
                Text {
                    ...
                    maximumLineCount: 1
                    width: Math.max(60, Math.min(implicitWidth, parent.width - (statusChip.visible ? statusChip.width + Theme.s2 : 0) - (originChip.visible ? originChip.width + Theme.s2 : 0)))
                }

                Chip {
                    id: originChip
                    visible: root.origin.length > 0 && !root.origin.startsWith("archlinux") && !root.origin.startsWith("fedora") && !root.origin.startsWith("debian")
                    text: root.origin
                    variant: "neutral"
                }
